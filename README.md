...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/throbbing-glade-8)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/throbbing-glade-8
```

A live public deployment of this template is available at [https://throbbing-glade-8.templates.workers.dev](https://throbbing-glade-8.templates.workers.dev)
